...
local xx = 420; -- Code to change the position of the camera to the left or right for your opponent, Less = Left (They can be negative numbers), More = Right
...
local xx2 = 470; -- Same code as above, but for boyfriend left, right
local yy2 = 250; -- Same code as above, but for boyfriend up, down
local xx3 = 450; -- Same code as above, but for girlfriend left, right
local yy3 = 250; -- Same code as above, but for girlfriend, up, down
